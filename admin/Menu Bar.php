  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="index.php"title="Admin Login"><span class="glyphicon glyphicon-log-in"></span>&nbsp;&nbsp;CS Login</a>
        </li>
        <li><a href="../Login.php"title="login"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;CD Login</a></li>
