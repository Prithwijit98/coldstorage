...
<html lang="en">
<head>
  <title>Himghar | CD Registration</title>
  <meta charset="utf-8">
...
<div class="container-fluid"style="background-color:#cacfce;color:#000;"> <!-- Primary Id-->
  <div class="container">
    <div class="row">
      <center><h1 style="background-color:#cacfce; border-radius:10px;display:inline-block;"><b><font color="#080808">Create New Account</font></b></h1></center>
      ...
      <div class="col-sm-6 ">
        <form class="form-horizontal"method="post">
          ...
          <div class="col-sm-8">
            ...
            <div class="form-group">
            <div class="control-label col-sm-5"><h4>DOB :</h4></div>
          <div class="col-sm-7">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7">
              <input type="tel" name="mobi" pattern="[0-9]{10}" class="form-control"placeholder="Enter Your Mobile Number"required>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7">
              <input type="tel" name="aadhar" pattern="[0-9]{12}" class="form-control"placeholder="Enter Your Aadhar Number"required>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7">
              <input type="text" name="pan" class="form-control"placeholder="Enter Your PAN Number"required>
          </div>
        </div>
          ...
          <div class="col-sm-7">
              <input type="text" name="desc" class="form-control"placeholder="Enter the commodities you deal with"required>
          </div>
        </div>
