...
?>
<div class="container-fluid"id="primary" style="background-color:#cacfce;"><!--Primary Id-->
  <center><h1 style="background-color:#cacfce;border-radius:50px;font-family: 'Baloo Bhai', cursive;display:inline-block;"><b><font color="#080808">User Profile</font></b></h1></center><br>
